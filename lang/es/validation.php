...
return [
    ...
    'attributes' => [
        ...
        'international_tracking' => 'número de rastreo internacional',
        ...
        'type' => 'tipo',
        'status' => 'estado',
        'confirm_correct' => 'confirmación de datos',
        'accept_costs' => 'aceptación de costos',
        'accept_contact' => 'aceptación de contacto',
        'services' => 'servicios',
        'products' => 'productos',
    ],
];
