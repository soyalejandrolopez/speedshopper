<x-public-layout title="{{ __('Send us your purchase request') }}">
    <div class="relative overflow-hidden bg-gradient-to-b from-emerald-50/70 via-white to-gray-50/50 py-8 sm:py-12 lg:py-16">
            ...
            <div class="grid gap-8 lg:grid-cols-12 lg:gap-12 lg:items-start">
                ...
                <div class="order-2 lg:order-1 lg:col-span-5 flex flex-col justify-between" data-reveal>
                    <div>
                        ...
                        <div class="mt-6 rounded-2xl border border-emerald-200 bg-gradient-to-br from-emerald-50 via-teal-50/60 to-white p-4 shadow-sm">
                            <div class="flex items-center gap-3.5">
                                ...
                                <div>
                                    <h3 class="text-sm font-bold text-gray-900">{{ __('Consolidación de Paquetes') }}</h3>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-100 grid grid-cols-3 gap-2.5 sm:gap-3 text-center">
                        <div class="rounded-2xl border border-gray-100 bg-white p-3 shadow-sm transition-colors hover:bg-emerald-50/60 hover:border-emerald-200">
