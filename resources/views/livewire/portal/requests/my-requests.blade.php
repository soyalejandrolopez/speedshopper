    ...
    <x-modal maxWidth="max-w-2xl">
        <form wire:submit="save">
                        <div class="flex items-center justify-between border-b border-gray-200 px-5 py-4">
                            <h3 class="text-base font-semibold text-gray-900">{{ __('New Purchase Request') }}</h3>
                        ...
                        <div class="grid gap-4 p-5 sm:grid-cols-2">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <input id="product_url-{{ $this->getId() }}" name="product_url" type="url" wire:model="form.product_url" placeholder="https://..." class="w-full rounded-lg border-gray-300 text-sm focus:border-emerald-500 focus:ring-emerald-500">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea id="description-{{ $this->getId() }}" name="description" wire:model="form.description" rows="3" placeholder="{{ __('Send us the links of the products you want') }}..." class="w-full rounded-lg border-gray-300 text-sm focus:border-emerald-500 focus:ring-emerald-500"></textarea>
                            </div>
                        </div>
