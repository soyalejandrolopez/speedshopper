<div wire:key="client-registration-form">
    ...
    @else
        <div class="mb-5">
            <div class="mb-1.5 flex items-center justify-between text-[11px] font-bold uppercase tracking-wider text-gray-500">
                <span>{{ __('Step') }} {{ $this->step }} {{ __('of') }} {{ \App\Livewire\ClientRegistrationForm::TOTAL_STEPS }}</span>
                <span class="text-emerald-700">{{ $this->progressPercent() }}%</span>
            </div>
            ...
            <div class="mt-2.5 flex items-center justify-between text-xs font-semibold">
                <span class="{{ $this->step === 1 ? 'text-emerald-700' : 'text-gray-400' }}">1 · {{ __('Personal') }}</span>
                <span class="{{ $this->step === 2 ? 'text-emerald-700' : 'text-gray-400' }}">2 · {{ __('Request') }}</span>
                <span class="{{ $this->step === 3 ? 'text-emerald-700' : 'text-gray-400' }}">3 · {{ __('Confirm') }}</span>
            </div>
        </div>
                    ...
                    <div class="mt-3 space-y-3">
                        ...
                        <div class="rounded-2xl border-2 border-teal-200 bg-gradient-to-br from-teal-50/90 via-emerald-50/50 to-white p-4 shadow-sm">
                            ...
                            <div class="grid gap-3 sm:grid-cols-3">
                                {{-- 1. Caja Small --}}
                                <div class="rounded-xl border {{ ($form['boxes_small'] ?? 0) > 0 ? 'border-teal-500 bg-teal-50/80 ring-2 ring-teal-400/30' : 'border-gray-200 bg-white' }} p-3.5 transition-all">
                                    <div class="flex items-center justify-between">
                                ...
                                {{-- 2. Caja Mediana --}}
                                <div class="rounded-xl border {{ ($form['boxes_medium'] ?? 0) > 0 ? 'border-teal-500 bg-teal-50/80 ring-2 ring-teal-400/30' : 'border-gray-200 bg-white' }} p-3.5 transition-all">
                                    <div class="flex items-center justify-between">
                                ...
                                {{-- 3. Caja Larga --}}
                                <div class="rounded-xl border {{ ($form['boxes_large'] ?? 0) > 0 ? 'border-teal-500 bg-teal-50/80 ring-2 ring-teal-400/30' : 'border-gray-200 bg-white' }} p-3.5 transition-all">
                                    <div class="flex items-center justify-between">
