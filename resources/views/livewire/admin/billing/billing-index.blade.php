<div>
    ...
    <div class="mb-6 grid gap-4 sm:grid-cols-3">
        <div class="rounded-2xl border border-gray-200/80 bg-white p-5 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs font-semibold uppercase tracking-wider text-gray-400">{{ __('Total Facturado en Compras') }}</p>
                    <p class="mt-1 text-2xl font-bold text-gray-900">{{ money($totalInvoicedRequests) }}</p>
                </div>
        ...
        <div class="rounded-2xl border border-gray-200/80 bg-white p-5 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs font-semibold uppercase tracking-wider text-gray-400">{{ __('Total Facturado en Envíos') }}</p>
                    <p class="mt-1 text-2xl font-bold text-gray-900">{{ money($totalInvoicedShipments) }}</p>
                </div>
        ...
        <div class="rounded-2xl border border-gray-200/80 bg-white p-5 shadow-sm">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-xs font-semibold uppercase tracking-wider text-gray-400">{{ __('Tarifario Oficial') }}</p>
                    <p class="mt-1 text-sm font-semibold text-emerald-700">{{ __('Sincronizado y Activo') }}</p>
                </div>
    ...
    {{-- Main Rate Sheet Configuration Card --}}
                ...
                <div class="border-t border-gray-100 pt-5">
                    ...
                    <div class="mt-3 grid gap-3 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.5" min="0" wire:model="rates.warehouse_percent"
                                   class="w-full rounded-lg border border-gray-300 text-sm focus:border-emerald-500 focus:ring-emerald-500">
                        </div>
                        <div>
